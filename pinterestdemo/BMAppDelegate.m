...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Assign the main entry point view to the window. We create a custom gridViewController using iOS 6's Collection Views wrapped in a UINavigationController.
    BMGridViewController *gridViewController = [[BMGridViewController alloc] initWithNibName:nil bundle:nil];
    UINavigationController *mainNavigationController = [[UINavigationController alloc] initWithRootViewController:gridViewController];
